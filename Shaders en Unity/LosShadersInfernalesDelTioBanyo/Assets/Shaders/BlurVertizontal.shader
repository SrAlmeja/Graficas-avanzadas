Shader "Unlit/BlurVertizontal"
{
    Properties
    {
        ...
        _kernelSizeX ("kernel SizeX",  Range(1, 30)) = 5
        _kernelSizeY ("kernel SizeY",  Range(1, 30)) = 5
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                for (int j = - _kernelSize; j <= _kernelSize; j++)
                {
                    ...
                    fixed4 sample = tex2D(_MainTex, i.uv + fixed2(weight * texelSize, weight * texelSize));
                    result += sample;
                }
