...
int main()
{
    ...
    GLfloat vertices[] =
    {
         -0.5f, -0.5f * float(sqrt(3)) / 3, 0.0f,       0.8f, 0.3f , 0.02f, // Esquina inferior izq
         0.5f, -0.5f * float(sqrt(3)) / 3, 0.0f,        0.8f, 0.3f , 0.02f, // Esquina inferior derecha
         0.0f, 0.5f * float(sqrt(3)) * 2 / 3, 0.0f,     1.0f, 0.6f , 0.32f, // Esquina superior
         -0.5f / 2, 0.5f * float(sqrt(3)) / 6, 0.0f,    0.9f, 0.45f, 0.17f, // Interior izquierda
         0.5f / 2, 0.5f * float(sqrt(3)) / 6, 0.0f,     0.9f, 0.45f, 0.17f, // Interior derecha
